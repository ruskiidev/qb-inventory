...
Config.InventoryUpdateCooldown  = 30 -- Seconds cooldown to save inventory changes
...
Config.MaxGloveboxWeight = 60000 -- Max weight a player can carry in glovebox (default 60kg, written in grams)
Config.MaxGloveboxSlots = 10      -- Max glovebox slots for a player
...
Config.WeaponAmmoByGroup = {
    [416676503] = "pistol_ammo",
    [970310034] = "rifle_ammo",
    [860033945] = "shotgun_ammo",
    [3337201093] = "smg_ammo",
    [-957766203] = "smg_ammo"
}
